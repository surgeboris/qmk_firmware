...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWERTY] = LAYOUT_split_3x6_3(
    ...
    OSL(L_LAYERNAV), LT(L_SYM, KC_SPC), KC_LGUI, HYPR(KC_M), LT(L_FN, KC_SPC), KC_RALT
  ),
  ...
  [L_MOUSE] = LAYOUT_split_3x6_3(
    LALT_T(KC_NLCK), KC_PWR, KC_BRIU, KC_EXEC, KC_BTN3, KC_APP, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_MPLY, LALT_T(KC_MUTE),
    LCTL_T(KC_CAPS), KC_WAKE, KC_ACL2, KC_ACL0, KC_BTN1, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_MNXT, RCTL_T(KC_VOLU),
    LSFT_T(KC_SLCK), KC_SLEP, KC_BRID, KC_FIND, KC_BTN4, KC_BTN5, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_MPRV, RSFT_T(KC_VOLD),
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
  [L_SYM] = LAYOUT_split_3x6_3(
    ...
    KC_TRNS, KC_TRNS, KC_RGUI, KC_TRNS, KC_TRNS, KC_TRNS
  ),
  [L_FN] = LAYOUT_split_3x6_3(
    LALT_T(KC_F1), KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, LALT_T(KC_F12),
    LCTL_T(KC_INS), LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), LGUI(KC_5), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_HOME, RCTL_T(KC_INS),
    LCTL_T(KC_PAUS), LGUI(KC_6), LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), LGUI(KC_0), LCTL(KC_LEFT), LCTL(KC_END), LCTL(KC_HOME), LCTL(KC_RIGHT), KC_END, RSFT_T(KC_PAUS),
    KC_TRNS, KC_TRNS, LCA(KC_DEL), KC_TRNS, KC_TRNS, LCA(KC_INS)
  ),
  [L_LAYERNAV] = LAYOUT_split_3x6_3(
    OSM(MOD_LALT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_MEH), OSM(MOD_LCTL|MOD_LSFT),
    OSM(MOD_LCTL), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_HYPR), OSM(MOD_LSFT|MOD_LALT),
