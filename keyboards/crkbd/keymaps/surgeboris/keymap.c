...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_FN] = LAYOUT_split_3x6_3(
    ...
    LCTL_T(KC_INS), LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), LGUI(KC_5), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, LCTL(KC_HOME), RCTL_T(KC_INS),
    LCTL_T(KC_PAUS), LGUI(KC_6), LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), LGUI(KC_0), LCTL(KC_LEFT), KC_HOME, KC_END, LCTL(KC_RIGHT), LCTL(KC_END), RSFT_T(KC_PAUS),
