...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_MOUSE] = LAYOUT_split_3x6_3(
    ...
    KC_TRNS, KC_MPLY, KC_ACL2, KC_ACL0, KC_BTN1, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_MUTE, RCTL_T(KC_PSCR),
  ...
  [L_LAYERNAV] = LAYOUT_split_3x6_3(
    OSM(MOD_LALT), KC_NLCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_MEH), OSM(MOD_LCTL|MOD_LSFT),
    OSM(MOD_LCTL), KC_CAPS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_HYPR), OSM(MOD_LSFT|MOD_LALT),
    OSM(MOD_LSFT), KC_SLCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, NK_TOGG, OSM(MOD_LCTL|MOD_LALT),
