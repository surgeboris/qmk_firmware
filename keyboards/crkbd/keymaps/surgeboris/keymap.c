...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWERTY] = LAYOUT_split_3x6_3(
    ...
    LCTL_T(KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LCTL_T(KC_QUOT),
    LSFT_T(KC_GRV), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LSFT_T(KC_ENT),
    OSL(L_LAYERNAV), LT(L_SYM, KC_SPC), KC_LGUI, TO(L_MOUSE), LT(L_FN, KC_SPC), KC_RALT
  ),
  [L_DVORAK] = LAYOUT_split_3x6_3(
    KC_TRNS, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_TRNS,
    KC_TRNS, KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, LCTL_T(KC_SLSH),
  ...
  [L_MOUSE] = LAYOUT_split_3x6_3(
    ...
    KC_TRNS, KC_MPLY, KC_ACL2, KC_ACL0, KC_BTN1, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_MUTE, LCTL_T(KC_PSCR),
    KC_TRNS, KC_MPRV, KC_BRID, KC_C, KC_V, KC_APP, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_VOLD, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, TO(L_QWERTY), KC_TRNS, KC_TRNS
  ),
  ...
  [L_FN] = LAYOUT_split_3x6_3(
    ...
    LCTL_T(KC_INS), LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), LGUI(KC_5), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, LCTL(KC_HOME), LCTL_T(KC_INS),
    LSFT_T(KC_PAUS), LGUI(KC_6), LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), LGUI(KC_0), LCTL(KC_LEFT), KC_HOME, KC_END, LCTL(KC_RIGHT), LCTL(KC_END), LSFT_T(KC_PAUS),
    KC_TRNS, KC_TRNS, LCA(KC_DEL), HYPR(KC_M), KC_TRNS, LCA(KC_INS)
  ),
